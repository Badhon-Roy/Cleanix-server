...
const serviceCategorySchema = new Schema<IServiceCategory>(
  {
    ...
    adminShare: { type: Number, required: true, default: 50 },
    teamLeaderShare: { type: Number, required: true, default: 10 },
    cleanerPoolShare: { type: Number, required: true, default: 40 },
